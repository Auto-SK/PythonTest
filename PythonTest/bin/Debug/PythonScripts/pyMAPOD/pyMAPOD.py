...
path_root = os.getcwd()  # root directory
path_work = r'PythonScripts/pyMAPOD/'  # work directory
os.chdir(path_work)  # change cwd to data directory
...
os.chdir(path_root)  # go back root path
